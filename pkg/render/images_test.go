...
var _ = Describe("registry and namespace override", func() {
	It("should render a calico image correctly", func() {
		Expect(constructImage(NodeImageNameCalico, "custom-reg.io/", "my-namespace")).To(Equal("custom-reg.io/my-namespace/node:" + components.VersionCalicoNode))
	})
	It("should render a tigera image correctly", func() {
		Expect(constructImage(NodeImageNameTigera, "custom-reg.io/", "my-namespace")).To(Equal("custom-reg.io/my-namespace/cnx-node:" + components.VersionTigeraNode))
	})
	It("should render an ECK image correctly", func() {
		Expect(constructImage(ECKOperatorImageName, "custom-reg.io/", "my-namespace")).To(Equal("custom-reg.io/my-namespace/eck-operator:" + components.VersionECKOperator))
	})
})
